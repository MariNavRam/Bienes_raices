...
<body>
    ...
    <section class="contenedor seccion">
        ...
        <div class="iconos-nosotros">
            <div class="icono">
                <img src="../assents/img/icono1.svg" alt="Icono Seguridad">
                <h3>Seguridad</h3>
                <p>Confia en nosotros!! somos una empresa de confianza certificada.</p>
            </div>

            <div class="icono">
                <img src="../assents/img/icono2.svg" alt="Icono Mejor Precio">
                <h3>El Mejor Precio</h3>
                <p>No lo pienses más, somos tu mejor opcion, precios mas bajos y seguros</p>
            </div>

            <div class="icono">
                <img src="../assents/img/icono3.svg" alt="Icono a Tiempo">
                <h3>A Tiempo</h3>
                <p>Con la mejor vanguardia, siempre actualizados!!.</p>
            </div>
        </div>
    </section>
    ...
    <main class="seccion contenedor">
        ...
        <div class="contenedor-anuncios">
            <div class="anuncio">
                <img src="../assents/img/anuncio1.jpg" alt="Anuncio casa en el lago">
            ...
            <div class="anuncio">
                <img src="../assents/img/anuncio3.jpg" alt="Anuncio casa con alberca">
                <div class="contenido-anuncio">
